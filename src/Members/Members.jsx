    ...
    <div>
      ...
      <div className="grid lg:grid-cols-2">
        <div className="flex gap-10 items-center p-3 m-3 shadow-lg">
          <img className="w-32 h-32 lg:w-72 lg:h-72 rounded-full" src="/public/Resources/team-member-1.jpg" alt="" />
        ...
        <div className="flex gap-10 items-center p-3 m-3 shadow-lg">
          <img className="w-32 h-32 lg:w-72 lg:h-72 rounded-full" src="/public/Resources/team-member-3.jpg" alt="" />
          <div className="space-y-3">
        ...
        <div className="flex gap-10 items-center p-3 m-3 shadow-lg">
          <img className="w-32 h-32 lg:w-72 lg:h-72 rounded-full" src="/public/Resources//team-member-4.jpg" alt="" />
          <div className="space-y-3">
        ...
        <div className="flex gap-10 items-center p-3 m-3 shadow-lg">
          <img className="w-32 h-32 lg:w-72 lg:h-72 rounded-full " src="/public/Resources/team-member-5.jpg" alt="" />
          <div className="space-y-3">
